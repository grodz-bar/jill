...
- **Wrong track order**: Tracks sort by subfolder, then album artist, album, disc number, track number, then filename. Check your files have the album artist tag set.
