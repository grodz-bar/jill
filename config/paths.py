...
#   3. Fallback default (if neither is set): ./music/ (relative to bot directory)
MUSIC_FOLDER = os.getenv('MUSIC_FOLDER', './music/')  # Path to your music files
...
CHANNEL_STORAGE_FILE = './last_channels.json'  # Path to channel storage file
